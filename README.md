...
For GitHub Pages, add the same name as a repository variable. The Search
Console HTML verification token is stored permanently in the site metadata so
it remains present across deployments.
